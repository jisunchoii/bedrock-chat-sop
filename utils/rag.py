...
class prompt_repo():
    ...
    prompt_types = ["qna_format_answer", "answer_only", "answer_with_ref", "original", "ko_answer_only", "violation_format_answer"]
    ...
    def get_qa(cls, prompt_type):
        ...
        if prompt_type == "qna_format_answer":
            ...
            First by summarizing the whole thing to form the first paragraph.
            Second, organize the details into bullet points
            The last paragraph should be a sentence that summarizes the whole thing.
            ...
            Answer in Korean.
            If the question cannot be answered by the context, say "관련 정보 없음".
        ...
        if prompt_type == "ko_answer_only":
            ...
            Answer in Korean.
            If the question cannot be answered by the context, say "제가 모르는 내용입니다.".
            \n\nAssistant: Here is the answer. """
            
        if prompt_type == "violation_format_answer":
            prompt = """
            \n\nHuman:
            You are a bot designed to analyze documents in the pharmaceutical manufacturing industry to ensure that they are written in accordance with national guidelines and pharmaceutical company SOPs.
            I'm going to give you a context. Read the context carefully, because I'm going to ask you a question about it.

            Here is the context: <context>{context}<\context>
            Take a deep dive into the following documentation and compare it to the most relevant content within guidelines or SOPs to see if there are any violations.
            In the first line, give the number of violations.
            In the second paragraph, print out the full text of the document and draw an arrow to show what the violation is.
            In the third paragraph, print out how to fix the document.
            ...
            Answer in Korean.
            If the question cannot be answered by the context, say "No relevant context".
            Don't include any tags like \<context\>.
            \n\nAssistant: Here is the answer. 
